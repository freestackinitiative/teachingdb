...
from teachdb.teachdb import _download_db, connect_db, connect_teachdb
...
def test_download_db(mocker):
    ...
    result = _download_db(mock_paths)
...
def test_connect_teachdb(mocker, database):
    ...
    mocker.patch('teachdb.loader._load_paths', return_value=mock_paths)
    mocker.patch('teachdb.teachdb._download_db', return_value={"ds_salaries": mock_df})
